...
from lib.utils.config import cfg,get_output_dir
...
def load_snapshot(saver,sess,output_dir):
...
if __name__ == '__main__':
    ...
    model,_ = get_model(args.demo_net)
    ...
    load_snapshot(saver, sess, output_dir)
    ...
    #for i in range(2):
    #    _, _= im_detect(sess, model, im)

    #im_names = ['000456.jpg', '000542.jpg', '001150.jpg','001763.jpg', '004545.jpg','000012.jpg']
    im_names = ['000456.jpg']

    for im_name in im_names:
        print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
        print('Demo for data/demo/{}'.format(im_name))
        demo(sess, model, im_name)
